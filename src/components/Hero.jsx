...
{/* Background Carousel */} <div className="absolute inset-0">
...
> <img
         ...
         /> <div className="absolute inset-0 bg-navy/40" /> <div className="absolute inset-0 bg-gradient-to-r from-navy/60 via-navy/30 to-transparent" /> </div>
))} </div>
...
```
  ...
  <div className="relative z-10 h-full flex items-center">
    <div className="container mx-auto px-6">
      <div className="max-w-4xl">
        ...
        {/* Subtitle */}
        <h2 className="text-subtitle font-display font-semibold text-gold mb-6 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
  ...
  <div className="absolute top-20 right-20 animate-float">
    <div className="w-20 h-20 rounded-full bg-gold/20 backdrop-blur-sm" />
  </div>
